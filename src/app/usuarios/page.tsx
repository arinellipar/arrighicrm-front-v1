...
export default function UsuariosPage() {
  ...
  const handleSelectUsuario = (usuarioId: number) => {
    setSelectedUsuarioId(usuarioId === selectedUsuarioId ? null : usuarioId);
  };
    ...
    <ProtectedRoute requiredModule="usuarios">
      <MainLayout>
        <div className="space-y-4 sm:space-y-5 lg:space-y-6 w-full max-w-none">
          ...
          {/* Painel de Ações para Usuário Selecionado */}
          <AnimatePresence>
            {selectedUsuarioId && (
              <motion.div
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -20 }}
                className="bg-gradient-to-r from-accent-500 to-accent-600 rounded-xl p-4 shadow-lg"
              >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {!isReadOnly() && (
                      <motion.button
                        ...
                        className="p-2 bg-white/20 hover:bg-red-500/30 rounded-lg transition-all duration-200"
                        title="Excluir"
                      >
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-3 lg:gap-4 w-full">
              ...
              >
                ...
                <option value="Administrativo de Filial">
                  Administrativo de Filial
                </option>
                <option value="Gestor de Filial">Gestor de Filial</option>
                <option value="Cobrança/Financeiro">Cobrança/Financeiro</option>
